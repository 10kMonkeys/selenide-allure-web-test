...
public class PageURL {
    ...
    public static final String IFRAME_PAGE_URL = "/IFrame/index.html";
    public static final String HIDDEN_ELEMENTS_PAGE_URL = "/Hidden-Elements/index.html";
    public static final String POPUPS_AND_ALERTS_PAGE_URL = "/Popup-Alerts/index.html";
}
